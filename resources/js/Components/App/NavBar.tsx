...
function NavBar() {
    ...
    return (
        <>
            <div className="flex gap-3 md:gap-6 bg-base-200 items-center w-full py-3 md:py-5 px-4 md:px-14 justify-between">
                <div className="flex text-black">
                    <Link className="logo bg-transparent hover:bg-transparent border-0 font-integral_cf font-extrabold text-[24px] md:text-[40px]"
                          href={route('home')}>
                        Tenten
                    </Link>
                </div>
                <div className="menu-nav hidden md:flex w-[fit-content] min-w-max gap-4 flex-row items-center p-0 font-satoshi font-medium text-[21px] my-auto">
                ...
                <div className="flex justify-end items-center gap-2 md:gap-4 my-auto min-w-max">
                    <button
            ...
            <div className={`fixed inset-0 z-50 md:hidden transition-all duration-300 ease-in-out ${isMobileMenuOpen ? 'opacity-100 visible' : 'opacity-0 invisible'}`}>
                ...
                ></div>
                <div className={`absolute top-0 right-0 h-full w-4/5 bg-base-100 shadow-xl transform transition-transform duration-300 ease-in-out ${isMobileMenuOpen ? 'translate-x-0' : 'translate-x-full'}`}>
                    <div className="flex items-center justify-between p-4 border-b">
                        <Link className="font-integral_cf font-extrabold text-2xl text-black" href={route('home')}>
                            Tenten
                        </Link>
                        <button
