    ...
    return (
        <div className="group bg-white rounded-2xl overflow-hidden transition-all duration-300
            ...
            <div className="p-6">
                <div className="mb-4">
                    <Link href={route('product.show', product.id)}>
                        <h3 className="font-satoshi font-bold text-lg text-black mb-2 line-clamp-2 hover:text-gray-700
                ...
                <div className="flex items-center justify-between gap-4">
                    <div className="flex flex-col">
                        ...
                        <div className="flex items-center gap-1">
                            <div className="flex">
                                {[...Array(5)].map((_, i) => (
                                    <svg key={i} width="14" height="14" viewBox="0 0 23 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <button
                        ...
                        className="bg-black text-white px-6 py-3 rounded-full font-satoshi font-medium
                                   text-sm hover:bg-gray-800 transition-all duration-300 hover:scale-105
