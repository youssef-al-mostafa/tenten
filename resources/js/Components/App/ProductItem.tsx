...
export const ProductItem = ({ product }: Props) => {
    ...
    return (
        <div className="group bg-white rounded-xl sm:rounded-2xl overflow-hidden transition-all duration-300
                        hover:shadow-2xl hover:-translate-y-1 sm:hover:-translate-y-2 border border-gray-100">
            ...
            <div className="p-3 sm:p-4 lg:p-6">
                <div className="mb-3 sm:mb-4">
                    <Link href={route('product.show', product.id)}>
                        <h3 className="font-satoshi font-bold text-base sm:text-lg text-black mb-2 line-clamp-2 hover:text-gray-700
                ...
                <div className="flex items-center justify-between gap-2 sm:gap-4">
                    ...
                    <button
                        ...
                        className="bg-black text-white px-3 sm:px-4 lg:px-6 py-2 sm:py-2.5 lg:py-3 rounded-full font-satoshi font-medium
                                   text-xs sm:text-sm hover:bg-gray-800 transition-all duration-300 hover:scale-105
                                   active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed flex
                                   items-center gap-1 sm:gap-2 min-w-fit whitespace-nowrap"
                    >
                        {form.processing ? (
                            <>
