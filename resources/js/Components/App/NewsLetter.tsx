                ...
                <div className='flex flex-col w-[50%] h-fit my-auto items-center justify-center gap-3'>
                    <div className='w-full max-w-72'>
                        <label className="input validator flex justify-center align-middle items-center h-fit w-full rounded-3xl">
                            ...
                            <input className='border-transparent w-full focus:border-transparent focus:shadow-none focus:ring-transparent' type="email" placeholder={content?.placeholder_text || ""} required />
                        </label>
                        <div className="validator-hint hidden">Enter valid email address</div>
                    </div>
                    {content?.button_text && (
                        <button className="btn rounded-3xl w-full max-w-72">{content.button_text}</button>
                    )}
                </div>
            </div>
        </div>
