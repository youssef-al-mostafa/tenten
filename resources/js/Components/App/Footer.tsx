            ...
            <div className="footer relative flex flex-col gap-2 bg-base-200 w-full h-fit pt-10 pb-5">
                <div className="footer-main flex justify-between w-[85%] mx-auto mb-3">
                    <div className="footer-col w-[22%] flex flex-col gap-7">
                        ...
                        <p className="font-satoshi font-normal text-xs leading-snug tracking-normal text-black opacity-60">
                            We have clothes that suits your style
                            and which you’re proud to wear.
                            From women to men.
                        </p>
                        <div className="social-media-row flex justify-start gap-5">
                            <a href="#" className="social-media-icon text-black overflow-hidden">
                    ...
                    <div className="footer-col w-[70%] flex justify-between">
                        <div className="footer-col-1 flex flex-col gap-3">
                            ...
                            <ul className="flex flex-col gap-2">
                                <li>
                                    <Link href="#" className="font-satoshi font-light text-xs leading-snug tracking-normal text-black opacity-60">About</Link>
                                </li>
                                <li>
                                    <Link href="#" className="font-satoshi font-light text-xs leading-snug tracking-normal text-black opacity-60">Features</Link>
                                </li>
                                <li>
                                    <Link href="#" className="font-satoshi font-light text-xs leading-snug tracking-normal text-black opacity-60">Works</Link>
                                </li>
                                <li>
                                    <Link href="#" className="font-satoshi font-light text-xs leading-snug tracking-normal text-black opacity-60">Career</Link>
                                </li>
                            </ul>
                        </div>
