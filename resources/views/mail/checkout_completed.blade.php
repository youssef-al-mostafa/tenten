<x-mail::message>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td padding='5' style="padding: 5px;">
                                                <img src="{{ $orderItem->product->image->getUrl('thumb') }}" alt="{{ $orderItem->product->title }}">
                                            </td>
    ...
    <x-mail::subcopy>
        <p>
            If you have any questions, feel free to contact our customer support team at <a href="mailto:support@tenten.com">support@tenten.com</a>.
        </p>
    </x-mail::subcopy>
